...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['Time For ', 'Workout']}>
            <Header index={'01'} title={'Type of Workout'} description={"Select the workout you wish to endure."} />
            ...
            <Header index={'02'} title={'Select the Muscle Group'} description={"Select the muscles judged for annihilation."} />
            ...
            <Header index={'03'} title={'Whats your End Goal'} description={"Select your ultimate objective."} />
